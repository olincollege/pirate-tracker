...
def plotting_incidents_map(coordinate_points): 
    ...
    ax.set_title("Pirate Attacks around Southeast Asia", fontsize=14, fontweight="bold")
    plt.savefig("Pirate_Attacks_Southeast_Asia.png", bbox_inches='tight', pad_inches=0)
